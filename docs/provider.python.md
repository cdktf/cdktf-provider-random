...
| <code><a href="#@cdktf/provider-random.provider.RandomProvider.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-random.provider.RandomProvider.toHclTerraform"></a>
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.6.2/docs#import import section} in the documentation of this resource for the id to use
