...
```go
import "github.com/cdktf/cdktf-provider-random-go/random/v9/stringresource"
...
| <code><a href="#@cdktf/provider-random.stringResource.StringResource.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
