...
// https://registry.terraform.io/providers/hashicorp/random/3.7.1/docs/resources/shuffle
...
export class Shuffle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Shuffle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.7.1/docs/resources/shuffle#import import section} in the documentation of this resource for the id to use
